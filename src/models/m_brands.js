...
function addData(data) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "INSERT INTO brands SET ?";
...
function updateData(data, id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "UPDATE brands SET ? WHERE id = ?";
...
function deleteData(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "DELETE FROM brands WHERE id = ?";
...
function getDataById(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM brands WHERE id = ?";
    conn.query(sqlQuery, id, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getDataByName(name) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM brands WHERE name = ?";
...
function getFieldsName() {
  return new Promise((resolve, reject) => {
    conn.query(`DESCRIBE brands`, function (error, result) {
      //      conn.query(`DESCRIBE brands`, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getTotalData() {
  return new Promise((resolve, reject) => {
    conn.query(`SELECT COUNT(id) AS total_data FROM brands`, function (error, result) {
      //      conn.query(`DESCRIBE brands`, function (error, result) {
      if (error) {
        reject(error);
      }
