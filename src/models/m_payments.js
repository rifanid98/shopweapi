...
function updateData(data, id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "UPDATE payments SET ? WHERE id = ?";
...
function deleteData(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "DELETE FROM payments WHERE id = ?";
...
function getDataById(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM payments WHERE id = ?";
    conn.query(sqlQuery, id, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getDataByName(name) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM payments WHERE name = ?";
...
function getFieldsName() {
  return new Promise((resolve, reject) => {
    conn.query(`DESCRIBE payments`, function (error, result) {
      //      conn.query(`DESCRIBE payments`, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getTotalData() {
  return new Promise((resolve, reject) => {
    conn.query(`SELECT COUNT(id) AS total_data FROM payments`, function (error, result) {
      //      conn.query(`DESCRIBE payments`, function (error, result) {
      if (error) {
        reject(error);
      }
