...
async function getData(filters, totalData, fields) {
  const sqlQuery = "SELECT * FROM `sizes` ";
...
function addData(data) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "INSERT INTO sizes SET ?";
...
function updateData(data, id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "UPDATE sizes SET ? WHERE id = ?";
...
function deleteData(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "DELETE FROM sizes WHERE id = ?";
...
function getDataById(id) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM sizes WHERE id = ?";
    conn.query(sqlQuery, id, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getDataByName(name) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM sizes WHERE name = ?";
...
function getFieldsName() {
  return new Promise((resolve, reject) => {
    conn.query(`DESCRIBE sizes`, function (error, result) {
      //      conn.query(`DESCRIBE sizes`, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getTotalData() {
  return new Promise((resolve, reject) => {
    conn.query(`SELECT COUNT(id) AS total_data FROM sizes`, function (error, result) {
      //      conn.query(`DESCRIBE sizes`, function (error, result) {
      if (error) {
        reject(error);
      }
