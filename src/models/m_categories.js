...
function getDataByName(name) {
  return new Promise((resolve, reject) => {
    const sqlQuery = "SELECT * FROM categories WHERE name = ?";
...
function getFieldsName() {
  return new Promise((resolve, reject) => {
    conn.query(`DESCRIBE categories`, function (error, result) {
      //      conn.query(`DESCRIBE categories`, function (error, result) {
      if (error) {
        reject(error);
      }
...
function getTotalData() {
  return new Promise((resolve, reject) => {
    conn.query(`SELECT COUNT(id) AS total_data FROM categories`, function (error, result) {
      //      conn.query(`DESCRIBE categories`, function (error, result) {
      if (error) {
        reject(error);
      }
